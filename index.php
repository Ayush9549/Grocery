...
<html lang="en">
	<head>
		...
		<!-- <link rel="stylesheet" href="./tranding_offer_data/assets/css/login_rgister.css"> -->
	...
	<body>
		<div class="container">
			...
			<div class="secton">
				...
				<div class="child">
					<div class="moto">Bring the <span>Store</span> to your <span> Door</span> in One hours</div>
				</div>
				<div class="child">
			...
			<div class="mobile_screen_menu">
				<div class="mobile_screen_home mobile_screen_btns"><img src="./assets/img/homed.png"></div>
				<div class="mobile_screen_categories mobile_screen_btns"><img src="./assets/img/category.png"></div>
				<div class="mobile_screen_profile mobile_screen_btns"><img src="./assets/img/user1.png"></div>
				<!-- <div class="footer_home"><img src="./assets/img/home.png"></div> -->
			</div>
			<footer>
				<?php
					include './footer.php';
