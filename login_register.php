			...
			<div class="login_container">
				...
				<div class="box2">
					<form class="log-form" action="login.php" method="post">
						...
						<div class="pass_area">
							<input name="password" class="password" type="password" method="post" placeholder="Enter Password">
							<img class="valid" src="./assets/img/check.png" alt="">
						</div>
						<div class="pass_error">Please enter correct password</div>
						<button class="log-btn">LOGIN</button>
						<a class="login-option" href="#">Forgot password?</a>
			...
			<div class="container1">
				...
				<div class="box4">
					...
					<form class="reg-form">
						...
						<!-- <input type="text" name="email" placeholder="Enter Email" class="num email"> -->
						<div class="email_area">
							<input name="email" class="email" type="text" placeholder="Enter email">
							<img class="valid" src="./assets/img/check.png" alt="">
						</div>
						...
						<input type="text" name="reg" placeholder="Enter Confirm Password" class="conf-pass">
